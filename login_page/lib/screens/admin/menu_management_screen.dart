    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: isDarkMode ? null : [
          BoxShadow(
            color: Colors.black.withOpacity(0.04), // shadow-[0_2px_8px_rgba(0,0,0,0.04)]
            blurRadius: 8,
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                item.imageUrl,
                fit: BoxFit.cover,
                errorBuilder: (_, __, ___) => Icon(Icons.fastfood, color: Colors.grey[400]),
              ),
            ),
          ),
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(8),
                                color: primaryColor.withOpacity(0.1), // bg-primary/10
                              ),
                              child: Row(
                                children: [
