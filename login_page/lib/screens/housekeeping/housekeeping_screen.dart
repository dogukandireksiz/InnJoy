...
class _HousekeepingScreenState extends State<HousekeepingScreen> {
        ...
        if (userDoc.exists && mounted) {
          ...
          if (userData != null) {
            setState(() {
              ...
              _guestName = userData['name_username'];
              _doNotDisturb = userData['doNotDisturb'] ?? false;
            });
            print('✅ User context loaded: Hotel=$_hotelName, Room=$_roomNumber, DND=$_doNotDisturb');
          } else {
  ...
  Future<void> _updateDoNotDisturb(bool? value) async {
    ...
    try {
      print('🔄 Updating DND to: $value for Hotel=$_hotelName, Room=$_roomNumber');
      ...
      print('✅ DND updated successfully');
